 ...
 * @version 1.0
 */
public class DefinitionOriginExpression implements Expression, SmartListenerConfigurationProvider
{

    /**
     * Returns empty collection if the specified object is not an OWL Restriction Class. If
     * specified object is an OWL Restriction Class then returns the set of DefinitionOrigin annotations
