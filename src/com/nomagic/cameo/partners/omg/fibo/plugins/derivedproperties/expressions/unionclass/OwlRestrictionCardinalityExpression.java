 ...
 * Time: 8:59 AM
 */
public class OwlRestrictionCardinalityExpression implements Expression, SmartListenerConfigurationProvider
{
    private final String stereoName = "owlRestriction";
    private final String propertyName = "cardinality";

    /**
     * Returns empty collection if the specified object is not an OWL Restriction Class. If
     * specified object is an OWL Restriction Class then returns the set of OWL Restrictions.
     *
    ...
    public Object getValue (@CheckForNull RefObject object)
    {
        ...
        if (object instanceof Class)
        {
            ...
            MatchingRelationByNameFinder matchingRelationByNameFinder = new MatchingRelationByNameFinder(owlClass);
