...
import com.nomagic.cameo.ontology.derivedproperties.expressions.StereotypedRelationByNameFinder;
import com.nomagic.cameo.ontology.derivedproperties.expressions.StereotypedRelationByNameFinder.RelationshipDirection;
...
public class ParentExpression implements Expression, SmartListenerConfigurationProvider
{
    ...
    public Object getValue (@CheckForNull RefObject object)
    {
        ...
        if (object instanceof Association)
        {
            ...
            {
                List<Association> superProperties = Lists.newArrayList();
