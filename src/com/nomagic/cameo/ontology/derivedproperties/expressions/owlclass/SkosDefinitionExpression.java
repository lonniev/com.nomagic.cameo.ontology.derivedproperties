 ...
 */
package com.nomagic.cameo.ontology.derivedproperties.expressions.owlclass;
...
/**
 * Expression collects and returns a collection of SKOS Definition InstanceSpecifications for
 * the OWL Class.
 *
        ...
        SmartListenerConfigurationProvider
{
     ...
     * specified object is an OWL class then returns the set of SKOS Definition InstanceSpecifications
     * for that OWL Class.
     *
